...
- `sectionSnap.ts` (só desktop / full motion) encaixa cada seção na viewport ao chegar. O miolo de cada trecho (pin do Sobre, galeria horizontal) continua com scroll livre.
